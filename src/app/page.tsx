...
export default function JamToolsPage() {
 ...
 const { query } = useSearch();                       // ✅ global query
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-800 text-white w-full">
      <main className="container mx-auto py-12 px-4">
        {/* 🔹 Dropdown */}
        <div className="relative w-full max-w-sm mb-8">
          <button
            onClick={() => setDropdownOpen(!dropdownOpen)}
            className="w-full flex items-center justify-between px-4 py-2 bg-black/50 text-white rounded-lg border border-gray-700 shadow-md backdrop-blur-md hover:bg-black/60 focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
          >
