      ...
      <div className="flex justify-center">
        <div className="w-full max-w-5xl space-y-8">
          ...
          <section className="space-y-2 border rounded-2xl p-5 bg-black">
            <label className="font-semibold text-white">Paste your .env content</label>
            <textarea
              value={envInput}
          ...
          <section className="space-y-2">
            <label className="font-semibold text-white">netlify.toml output</label>
            <pre className="p-3 rounded-lg border border-gray-300 bg-black text-[#9B4DF4] font-mono text-sm">
              {netlifyOutput}
            </pre>
            <button
              onClick={handleCopy}
