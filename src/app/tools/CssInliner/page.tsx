      ...
      <div className="container mx-auto max-w-4xl flex flex-col items-center space-y-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 w-full">
          <div className="bg-black p-6 rounded-2xl shadow-md border border-gray-800 flex flex-col items-start gap-3 hover:shadow-lg transition">
            ...
            <button className="px-4 py-2 border text-black bg-[#9B4DF4] border-gray-600 rounded-xl hover:text-white hover:bg-[#52139a] transition">
              Contribute
            </button>
          </div>
          ...
          <div className="bg-black p-6 rounded-2xl shadow-md border border-gray-800 flex flex-col items-start gap-3 hover:shadow-lg transition">
            ...
            <button className="px-4 py-2 border border-gray-600 text-black rounded-xl bg-[#9B4DF4] hover:bg-[#571f98] hover:text-white transition">
              Try Jam
            </button>
          </div>
        </div>
