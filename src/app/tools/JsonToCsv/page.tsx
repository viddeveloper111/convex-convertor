    ...
    <div className="bg-[#181023] min-h-screen p-6">
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-5xl space-y-8">
          ...
          {/* Input Section */}
          <section className="space-y-2 border p-5 rounded-2xl bg-black">
          ...
          <section className="space-y-2">
            ...
            <pre className="p-4 rounded-lg border border-gray-300 bg-black text-[#9B4DF4] font-mono text-sm focus:ring-2 focus:ring-[#9B4DF4]">
              {csvOutput}
            </pre>
            <button
              onClick={handleCopy}
