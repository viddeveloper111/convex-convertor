...
export default function CsvToJsonPage() {
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLInputElement>) => {
    if (e.key === "Enter") {
      // redirect to  Convex Converter.dev or a typed link
      window.location.href = "https:// Convex Converter.dev";
    }
  };
      ...
      <div className="max-w-8xl mx-auto container">
        ...
        <header className="mb-6 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="rounded-2xl border border-gray-300 px-4 py-2 bg-gray-200 text-black hover:bg-gray-500"
          >
            Upload CSV
          </button>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* CSV input */}
          <div className="bg-white rounded-2xl p-4 border border-gray-300 text-black">
            <div className="flex flex-wrap items-center gap-3 mb-3">
              <label className="text-sm text-gray-700">Delimiter</label>
              <select
                className="bg-white border border-gray-300 rounded-xl px-3 py-2"
                value={delimiter}
            ...
            <textarea
              ...
              className="w-full h-64 md:h-[28rem] bg-white text-black rounded-xl p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#9B4DF4] font-mono"
          ...
          {/* JSON output */}
          <div className="bg-white rounded-2xl p-4 border border-gray-300 flex flex-col text-black">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-lg font-medium">JSON Output</h2>
              <div className="flex items-center gap-2">
                <button
                  onClick={handleCopy}
                  className="rounded-xl border border-gray-300 px-3 py-1.5 hover:bg-gray-100 text-sm"
                >
                  Copy JSON
                </button>
                <button
            ...
            <pre className="flex-1 overflow-auto rounded-xl bg-gray-50 text-purple-700 p-3 border border-gray-300 text-sm whitespace-pre-wrap">
        ...
        <div className="mt-8 text-black space-y-2 text-sm">
          <p>You can convert CSV files into JSON online with this free tool...</p>
        </div>
<div className=" text-black space-y-2 text-sm">
  <p>
    Just paste your CSV file and get the JSON result. Built with 💜 by the developers at  Convex Converter, using the open-source{" "}
...
<div className="mt-8 text-black space-y-2 text-sm">
  <h2 className="text-xl font-semibold mb-2  text-black">How to Use  Convex Converter CSV to JSON Converter Tool</h2>
  <p>
...
<div className="mt-8 text-black text-sm space-y-2">
    <h2 className="text-xl font-semibold mb-2  text-black">More JSON Utilities —</h2>
  <p className="mb-2">
     Beautify JSON, convert from query parameters, or YAML with  Convex Converter free developer utilities. They're all available in dark mode too.
  </p>
...
<div className="mt-8 text-black text-sm space-y-2">
<h2 className="text-xl font-semibold mb-2  text-black">Benefits of Converting CSV to JSON format</h2>
  <p className="mb-2">
...
<div className="mt-8 text-black text-sm space-y-4">
  <h2 className="text-xl font-semibold mb-2 text-black">FAQs</h2>
  <ul className="list-disc list-inside space-y-2">
    ...
    <li>
      <strong>How easy is it to use the CSV to JSON converter?</strong>  Convex Converter's converter is user-friendly and intuitive, allowing anyone to use it without technical knowledge. Simply paste your CSV file, and the tool will do the rest.
    </li>
    <li>
