      ...
      <div className="flex justify-center">
        <div className="w-full max-w-5xl space-y-8">
          ...
          <section className="p-6 space-y-2">
            ...
            <p className="text-white">PS. Scroll down for even faster debugging.</p>
          </section>

          {/* How to View HAR Files */}
          <section className="p-6 space-y-2">
            <h2 className="text-2xl font-bold text-white">How to View HAR Files Online</h2>
          ...
          <section className="p-6 space-y-2">
            <h2 className="text-2xl font-bold text-white">How to Create a HAR File</h2>
          ...
          <section className="p-6 space-y-4">
            ...
            <p className="text-gray-400">
              Skip the manual process of generating HAR files — let Jam do the work for you. With Jam’s browser extension, you get everything a HAR file offers plus automatic steps to reproduce, metadata, and AI-powered debugging assistance.
            </p>
          ...
          {/* HAR Analyzer */}
          <section className="p-6 space-y-2">
            <h2 className="text-2xl font-bold text-white">How to Use the HAR Analyzer for Debugging</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-400">
